 ...
 */
function readWavPcmSamples(wavPath) {
 ...
 */
function extractSegmentAcousticFeatures(allSamples, startSec, endSec, sampleRate = 16000) {
 ...
 */
function clusterSegmentsToSpeakers(segments, wavPath, numSpeakers = 2) {
...
module.exports = {
  ...
  extractSegmentAcousticFeatures,
  clusterSegmentsToSpeakers,
};
